...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <Card className={`${styles.card} w-full max-w-md mx-auto text-center`}>
        <CardHeader>
          <CardTitle className={styles.cardTitle}>Weather Widget</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSearch} className="flex items-center gap-2">
            <Input
              className={styles.input} // Use styles from the CSS module
              type="text"
          ...
          {weather && (
            <div className={`${styles.weatherInfo} mt-4 grid gap-2`}>
